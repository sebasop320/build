import { c as create_ssr_component, b as subscribe, f as each, e as escape, d as add_attribute, h as null_to_empty } from './index-09f75f86.js';
import { r as readable } from './index3-5b73329d.js';
...
${$$result.head += `<!-- HEAD_svelte-1sztb41_START -->${$$result.title = `<title>WordPuzle</title>`, ""}<meta name="${"description"}" content="${"A Wordle clone written in SvelteKit"}"><script async src="${"https://www.googletagmanager.com/gtag/js?id=G-TNQZ8BJ0PF"}"><\/script><script>window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-TNQZ8BJ0PF');
<\/script><!-- HEAD_svelte-1sztb41_END -->`, ""}
...
//# sourceMappingURL=_page.svelte-23a03436.js.map
