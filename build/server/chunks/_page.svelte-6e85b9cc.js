...
${$$result.head += `<!-- HEAD_svelte-1iiawab_START -->${$$result.title = `<title>WordPuzle</title>`, ""}<meta name="${"description"}" content="${"A Wordle clone written in SvelteKit"}"><!-- HEAD_svelte-1iiawab_END -->`, ""}
...
//# sourceMappingURL=_page.svelte-6e85b9cc.js.map
