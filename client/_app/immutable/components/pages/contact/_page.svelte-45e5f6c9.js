...
`),E=u("style"),D=y(`h1{
    ...
    font-weight: 'bold';
    font-size: 4em;
  }`),j=f(),n=u("form"),L=u("label"),B=y("Name"),I=f(),T=u("input"),M=f(),x=u("label"),C=y("Email"),O=f(),k=u("input"),H=f(),S=u("label"),J=y("Message"),R=f(),F=u("textarea"),U=f(),P=u("input"),Z=f(),A=u("style"),z=y(`/* Style the submit button with a specific background color etc */
input[type=submit] {
...
`),E=m(Q,"STYLE",{});var W=h(E);D=v(W,`h1{
    color: #f25416;
    font-family: 'Bold'
    font-weight: 'bold';
    font-size: 4em;
  }`),W.forEach(o),Q.forEach(o),j=b(d),n=m(d,"FORM",{});var i=h(n);L=m(i,"LABEL",{});var X=h(L);B=v(X,"Name"),X.forEach(o),I=b(i),T=m(i,"INPUT",{type:!0,name:!0}),M=b(i),x=m(i,"LABEL",{});var K=h(x);C=v(K,"Email"),K.forEach(o),O=b(i),k=m(i,"INPUT",{type:!0,name:!0}),H=b(i),S=m(i,"LABEL",{});var ee=h(S);J=v(ee,"Message"),ee.forEach(o),R=b(i),F=m(i,"TEXTAREA",{name:!0}),h(F).forEach(o),U=b(i),P=m(i,"INPUT",{type:!0}),Z=b(i),A=m(i,"STYLE",{});var te=h(A);z=v(te,`/* Style the submit button with a specific background color etc */
input[type=submit] {
  background-color: #04AA6D;
  color: white;
...
.container {
  ...
  background-color: #f2f2f2;
  padding: 20px;
}`),te.forEach(o),i.forEach(o),this.h()},h(){e.async=!0,ce(e.src,c="https://www.googletagmanager.com/gtag/js?id=G-TNQZ8BJ0PF")||w(e,"src",c),document.title="Let's have a talk",w(T,"type","text"),w(T,"name","user_name"),w(k,"type","email"),w(k,"name","user_email"),w(F,"name","message"),w(P,"type","submit"),P.value="Send"},m(d,_){t(document.head,e),t(document.head,s),t(s,p),q(d,l,_),q(d,r,_),t(r,g),t(r,E),t(E,D),q(d,j,_),q(d,n,_),t(n,L),t(L,B),t(n,I),t(n,T),t(n,M),t(n,x),t(x,C),t(n,O),t(n,k),t(n,H),t(n,S),t(S,J),t(n,R),t(n,F),t(n,U),t(n,P),t(n,Z),t(n,A),t(A,z),G||(Y=ue(n,"submit",me(a[0])),G=!0)},p:V,i:V,o:V,d(d){o(e),o(s),d&&o(l),d&&o(r),d&&o(j),d&&o(n),G=!1,Y()}}}function ye(a){function e(c){ge.sendForm("service_4bzrx0a","template_94gqytg",c.target,"kYZTkMFOPTOCbLSAC").then(s=>{alert("SUCCESS!",s.text)},s=>{alert("FAILED...",s.text)})}return[e]}class we extends se{constructor(e){super(),ie(this,e,ye,_e,le,{})}}export{we as default};
